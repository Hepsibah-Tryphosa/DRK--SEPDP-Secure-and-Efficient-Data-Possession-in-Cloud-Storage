...
<body>
	...
	<div class="limiter">
		<div class="container-table100">
			...
			String filename=null,fileid=null,hkeystatus="yes",aboutfile=null,secretkey=null,ownername=null,hashkey="no";
ResultSet rs=null;
...
try
{
	Connection con = DbConnection.getConnection();
        String qry="select fid, fname, abfile, secretkey,ownername from filedetails where hkeystatus='"+hkeystatus+"'and hashkey='"+hashkey+"'";
						...
						<tbody>
								<tr>
									...
									<td class="column3"><%=ownername%></td>
                                                                        ...
                                                                        <td class="column5"><a href="hashkeygenrator.jsp?ownername=<%=ownername%>&&fid=<%=fileid%>">Audit Request to generate Hashkey</a></td>
