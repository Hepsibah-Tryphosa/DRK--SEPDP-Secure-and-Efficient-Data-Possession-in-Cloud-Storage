                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="yummyfood-nav">
                            <ul class="navbar-nav" id="yummy-nav">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link" href="cloudLogin.jsp">logout<span class="sr-only">(current)</span></a>
                                </li>
    ...
    <div class="breadcumb-area" style="background-image: url(bg-img/background-board-brown-326311.jpg);">
       ...
       <div class="limiter">
		<div class="container-table100">
					...
					<table>
						<thead>
							<tr class="table100-head">
								<th class="column1">Owner ID</th>
								<th class="column2">Owner name</th>
								<th class="column3">owner Email</th>
			...
			String ownerId=null,name=null,email=null,address=null;
ResultSet rs=null;
...
try
{
	Connection con = DbConnection.getConnection();
        String qry="select ownerId, name, email, address from ownerreg";
