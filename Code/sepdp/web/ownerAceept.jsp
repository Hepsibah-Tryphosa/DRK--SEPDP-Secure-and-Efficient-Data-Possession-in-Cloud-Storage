...
<!--===============================================================================================-->
	...
	<div class="limiter">
		<div class="container-table100">
			...
			String filename=null, tpastatus="yes", ownername=null,fid=null,uemail=null,ownerstaus="no",hashkey=null;
ResultSet rs=null;

try
{
	Connection con = DbConnection.getConnection();
        String qry="select * from userreq where ownerstaus='"+ownerstaus+"'and tpastatus='"+tpastatus+"'";
						...
						<tbody>
								<tr>
									...
									<td class="column2"><%=uemail%></td>
                                                                        <td class="column5"><a href="oupdate.jsp?uemail=<%=uemail%>&&fid=<%=fid%>"> Request Accepted </a></td>
